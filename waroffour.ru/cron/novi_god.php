...
include_once("other_inc/header.php");
 ...
 $query="SELECT * FROM `countries` LEFT JOIN `messages` ON countries.countryID=messages.countryID and messages.`from` = 'loose' WHERE mir='1' and messages.countryID IS NULL";
