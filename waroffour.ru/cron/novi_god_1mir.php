 ...
 */
 ...
 while(($a=mysql_fetch_array($result))!==FALSE){
  ...
  /*
  if ($a['countryName'] != 'litecoins'){
	continue;
  }else{
	print "lokal new year for me";
  }
  */
  ...
  $monTime=time()-$a['lastWar'];
  $gtr=0.5;
  $money_plus=round($mountains*$gtr)*10;
  if($money_plus>0)
  $new=CountryInfo($countryID);
  if((time()-$new['lastWar'])>172800 AND $new['lastWar']!=0)
  $money_plus=max(1,floor($money_plus/(((time()-$new['lastWar'])/86400)/2)));
 ...
 if ($general!==FALSE){
 if(                ($general['age']>(80+7*otkr_exists($countryID,'DOLG')) && round(rand($general['age'],160+14*otkr_exists($countryID,'DOLG')-$general['age']))==(80+7*otkr_exists($countryID,'DOLG')))   OR    ( $general['age'] > 87)         ){
...
if(ActivPhone($countryID)!==FALSE){$messages.="Ваш профиль не активирован. Страна удалена.<br />"; looser($countryID);}
...
$query = "SELECT money,countryName FROM `countries` WHERE mir = '1' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' order by money desc LIMIT 10";
$r = mysql_query($query);
...
$query = "SELECT (land+mountains+forest) as fland,countryName FROM `countries` WHERE mir = '1' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' order by (land+mountains+forest) desc LIMIT 10";
$r = mysql_query($query);
...
10*weapon_speed_8) as koef,countryName FROM `countries` WHERE mir = '1' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' order by koef desc LIMIT 10";
$r = mysql_query($query);
...
$query = "SELECT expiriense,countryName FROM `general`,`countries` WHERE mir = '1' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' and general.countryID = countries.countryID order by expiriense desc LIMIT 10";
$r = mysql_query($query);
...
$query = "SELECT (study+moral) as koef,countryName FROM `general`,`countries` WHERE mir = '1' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' and general.countryID = countries.countryID order by (study+moral) desc LIMIT 10";
$r = mysql_query($query);
...
$query = "SELECT age as koef,countryName FROM `general`,`countries` WHERE mir = '1' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' and general.countryID = countries.countryID order by age desc LIMIT 10";
$r = mysql_query($query);
...
$query = "SELECT (0.2*grain+arbor+4*stone+12*iron+20*oil) as koef,countryName FROM `countries` WHERE mir = '1' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' order by koef desc LIMIT 10";
$r = mysql_query($query);
