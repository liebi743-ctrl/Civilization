...
include_once("../other_inc/header.php");
 ...
 $query="SELECT * FROM `countries` LEFT JOIN `messages` ON countries.countryID=messages.countryID and messages.`from` = 'loose' WHERE mir='2' and ip!='' and ip!='sysreg' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and messages.countryID IS NULL";
...
$open=fopen(_ROOT."/liders/wariors2.dat","w+");
@flock ($open,LOCK_EX);
...
$open=fopen(_ROOT."/liders/population2.dat","w+");
@flock ($open,LOCK_EX);
...
$query = "SELECT money,countryName FROM `countries` WHERE mir = '2' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' order by money desc LIMIT 10";
$r = mysql_query($query);
$open=fopen(_ROOT."/liders/money2.dat","w+");
@flock ($open,LOCK_EX);
...
$query = "SELECT (land+mountains+forest) as fland,countryName FROM `countries` WHERE mir = '2' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' order by (land+mountains+forest) desc LIMIT 10";
$r = mysql_query($query);
$open=fopen(_ROOT."/liders/land2.dat","w+");
@flock ($open,LOCK_EX);
while (($a=mysql_fetch_array($r))!==FALSE){
...
10*weapon_speed_8) as koef,countryName FROM `countries` WHERE mir = '2' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' order by koef desc LIMIT 10";
$r = mysql_query($query);

$open=fopen(_ROOT."/liders/params2.dat","w+");
@flock ($open,LOCK_EX);
while (($a=mysql_fetch_array($r))!==FALSE){
...
$query = "SELECT expiriense,countryName FROM `general`,`countries` WHERE mir = '2' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and general.countryID = countries.countryID order by expiriense desc LIMIT 10";
$r = mysql_query($query);

$open=fopen(_ROOT."/liders/general_exp2.dat","w+");
@flock ($open,LOCK_EX);
while (($a=mysql_fetch_array($r))!==FALSE){
...
$query = "SELECT (study+moral) as koef,countryName FROM `general`,`countries` WHERE mir = '2' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and general.countryID = countries.countryID order by (study+moral) desc LIMIT 10";
$r = mysql_query($query);

$open=fopen(_ROOT."/liders/general2.dat","w+");
@flock ($open,LOCK_EX);
while (($a=mysql_fetch_array($r))!==FALSE){
      @fwrite($open,$a['countryName'].'*'.$a['koef']."\n");
      }
...
$query = "SELECT age as koef,countryName FROM `general`,`countries` WHERE mir = '2' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and general.countryID = countries.countryID order by age desc LIMIT 10";
$r = mysql_query($query);

$open=fopen(_ROOT."/liders/general_age2.dat","w+");
@flock ($open,LOCK_EX);
while (($a=mysql_fetch_array($r))!==FALSE){
      @fwrite($open,$a['countryName'].'*'.$a['koef']."\n");
      }
...
$query = "SELECT (0.2*grain+arbor+4*stone+12*iron+20*oil) as koef,countryName FROM `countries` WHERE mir = '2' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' order by koef desc LIMIT 10";
$r = mysql_query($query);

$open=fopen(_ROOT."/liders/res2.dat","w+");
@flock ($open,LOCK_EX);
while (($a=mysql_fetch_array($r))!==FALSE){
      @fwrite($open,$a['countryName'].'*'.$a['koef']."\n");
      }
