...
@include_once("../other_inc/startres.php");
 ...
 $countryName = 'Руины '.rand(100000,9999999);
 ...
 reggedTime='".(time()-468000)."', nalog=1, napr=0, lastNal = '".(time()-468000)."', lastWar = '".(time()-468000)."', land = $land, mountains=$mountains,
 ...
 $speed = rand(1,3);
 $query="INSERT INTO countries SET countryID = '$countryID', countryName = '$countryName',
 reggedTime='".(time()-360000)."', nalog=1, napr=0, lastNal = '".(time()-360000)."', lastWar = '".(time()-360000)."', land = $land, mountains=$mountains,
 forest=$forest, money=$money, arbor=$arbor, stone=$stone, iron=$iron, grain=$grain, oil=$oil,
 workers=$workers, scientists=$scientists, science=10, plotn_people=10, plotn_wariors=3,
 people_adding=10, forest_adding=10, grain_making=10, arbor_making=10, iron_making=10,
 stone_making=10, oil_making=10, forest_max=10, mountains_max=10, spy=10, sabotage=10, grabber=10,
 ...
 $speed = rand(1,3);
 $query="INSERT INTO countries SET countryID = '$countryID', countryName = '$countryName',
 reggedTime='".(time()-288000)."',  nalog=1, napr=0, lastNal = '".(time()-288000)."', lastWar = '".(time()-288000)."', land = $land, mountains=$mountains,
 forest=$forest, money=$money, arbor=$arbor, stone=$stone, iron=$iron, grain=$grain, oil=$oil,
 workers=$workers, scientists=$scientists, science=10, plotn_people=10, plotn_wariors=3,
 people_adding=10, forest_adding=10, grain_making=10, arbor_making=10, iron_making=10,
 stone_making=10, oil_making=10, forest_max=10, mountains_max=10, spy=10, sabotage=10, grabber=10,
 ...
 $speed = rand(1,3);
 $query="INSERT INTO countries SET countryID = '$countryID', countryName = '$countryName',
 reggedTime= '".(time()-180000)."', nalog=1, napr=0, lastNal = '".(time()-180000)."', lastWar = '".(time()-180000)."', land = $land, mountains=$mountains,
 forest=$forest, money=$money, arbor=$arbor, stone=$stone, iron=$iron, grain=$grain, oil=$oil,
 workers=$workers, scientists=$scientists, science=10, plotn_people=10, plotn_wariors=3,
 people_adding=10, forest_adding=10, grain_making=10, arbor_making=10, iron_making=10,
 stone_making=10, oil_making=10, forest_max=10, mountains_max=10, spy=10, sabotage=10, grabber=10,
 ...
 $speed = rand(1,3);
 $query="INSERT INTO countries SET countryID = '$countryID', countryName = '$countryName',
 reggedTime= '".(time()-108000)."', nalog=1, napr=0, lastNal = '".(time()-108000)."', lastWar = '".(time()-108000)."', land = $land, mountains=$mountains,
 forest=$forest, money=$money, arbor=$arbor, stone=$stone, iron=$iron, grain=$grain, oil=$oil,
 workers=$workers, scientists=$scientists, science=10, plotn_people=10, plotn_wariors=3,
 people_adding=10, forest_adding=10, grain_making=10, arbor_making=10, iron_making=10,
 stone_making=10, oil_making=10, forest_max=10, mountains_max=10, spy=10, sabotage=10, grabber=10,
 ...
 $speed = rand(1,3);
 $query="INSERT INTO countries SET countryID = '$countryID', countryName = '$countryName',
 reggedTime= '".(time()-36000)."', nalog=1, napr=0, lastNal = '".(time()-36000)."', lastWar = '".(time()-36000)."', land = $land, mountains=$mountains,
 forest=$forest, money=$money, arbor=$arbor, stone=$stone, iron=$iron, grain=$grain, oil=$oil,
 workers=$workers, scientists=$scientists, science=10, plotn_people=10, plotn_wariors=3,
 people_adding=10, forest_adding=10, grain_making=10, arbor_making=10, iron_making=10,
 stone_making=10, oil_making=10, forest_max=10, mountains_max=10, spy=10, sabotage=10, grabber=10,
