...
{
if ($pokup_res['what'] == "arbor") {$t1='дерева'; $t2='всё дерево'; $colpr=1500;}
if ($pokup_res['what'] == "stone") {$t1='камня'; $t2='весь камень'; $colpr=250;}
if ($pokup_res['what'] == "iron") {$t1='железа'; $t2='всё железо'; $colpr=50;}
if ($pokup_res['what'] == "grain") {$t1='зерна'; $t2='всё зерно'; $colpr=1500;}
if ($pokup_res['what'] == "oil") {$t1='нефти'; $t2='всю нефть'; $colpr=50;}
