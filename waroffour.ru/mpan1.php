...
$older4 = array(7,11040,10770);//admin
$older = array(7,79,11040,10770,77532,243023);//boss moder
//$older=array();
if (in_array($_SESSION['userID'],$older))$level=1;
else $level=0;
$older2 = array(100,88,10886,40,5315,139,2252,67904,121971,77535,79005,80336,81035,190195,198503,250817);//moder
//$older=array();
...
if($aaaa = mysql_fetch_array(mysql_query("SELECT * FROM `countries` WHERE countryName = '$country22' LIMIT 1"))!==FALSE){
	...
	if($bbbb['countryID']=='f09735cdd4e93841d4d4020aa513a8bc19'){
        ...
        printrus ("<a href='mpan1.php?$ses'>&lt;назад</a><br/>\r\n");
        include_once("other_inc/footer.php");
        die();
...
printrus("Cтрана:<br/>\n");  //".$_REQUEST['name']."
printrus ("<form name=\"\" action=\"mpan1.php?$ses\" method=\"post\">
...
printrus("*****<br/>");
printrus
("<input name=\"go\" type=\"radio\" value=\"sjech\" />Сжечь\n
<br/>
");

/*printrus
("<input name=\"go\" type=\"radio\" value=\"narisovat\" />Нарисовать\n
<br/>
");
*/

printrus
("<a href=\"prv123.php?$ses\">
Приваты(секретная информация!)</a>
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"logsmes\"/>Логи общения\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"logsworks\"/>Логи работ\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"logscit\"/>Логи цитадели\n
<br/>
");
printrus("*****<br/>");
}
...
printrus("*****<br/>");
printrus
("<input name=\"go\" type=\"radio\" value=\"rename\"/>Переименовать\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"sjech\"/>Сжечь\n
...
printrus
("<input name=\"go\" type=\"radio\" value=\"check\" />Удалить/блокировать\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"clone\"/>Поис клонов\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"countries\"/>Страны\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"logs\"/>Логи обменов\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"logszah\"/>Логи захватов\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"logswars\"/>Логи войн\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"logsjech\"/>Лог сжиганий\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"logssos\"/>Логи соседей\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"logsmag\"/>Логи магазина\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"ignor\"/>Вынуть из игнора\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"unblock\"/>Разблокировать\n
<br/>
");
printrus
("<input name=\"go\" type=\"radio\" value=\"map\"/>Карта\n
<br /><input type=\"submit\" value=\"Вперёд\"/>
</form><br/>
");
printrus
("
<a href=\"mpan1.php?$ses&amp;go=rules\"><b>Правила</b></a><br/>
<a href=\"mpan1.php?$ses&amp;go=help\">Помощь</a><br/>
");
}elseif($go=='map'){
...
$country1 = check($name);
  ...
  echo mysql_error();
  $npg = $pg-9;
  if ($pg>0) printrus ("<a href='mpan1.php?go=map&amp;pg=$npg&amp;$ses'>&lt;&lt;запад</a> ");
  ...
  $npg = $pg+9;
  printrus ("<a href='mpan1.php?go=map&amp;pg=$npg&amp;$ses'>&gt;&gt;восток</a><br/>-------<br/>\r\n");

  printrus ("<a href='mpan1.php?$ses'>еще...</a><br/>\r\n");
  }
...
("<a href=\"mpan1.php?$ses&amp;go=kill&amp;cid=$cid\">Убить!</a><br/>
");
if ($_SESSION['userID']!=20005)printrus
("<a href=\"mpan1.php?$ses&amp;go=block&amp;cid=$cid\">Блокировать доступ</a><br/>
");
...
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=verkill&amp;cid=$cid\" method=\"post\">
...
printrus("Причина (здесь напишите страны-клоны, либо обмены-сливы и т.п.):<br/>\n");
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=verblock&amp;cid=$cid\" method=\"post\">
<input name=\"purp\" maxlength=\"1500\" title=\"Text\" value=\"\"/>
<br/>\n");
...
if (mysql_num_rows($r)==0){
  ...
  $result = mysql_query($query);
   ...
   printrus("<u><i><a href=\"mpan1.php?name=".$r2[0]."$nus&amp;$ses\">".$r2[0]."</a></i></u> ( <i>last ip <b>".$r2[1]."</b></i>)[".$text."][".$txt."],<br />\n");
   }
   printrus("</p>\n");
...
if (mysql_num_rows($r)==0 && !isset($_REQUEST[id]) && !isset($cid)){
   ...
   if (!file_exists(_ROOT."/logs_old/$cid")){
      printrus ("<b>!</b>По этой стране нет логов<b>!</b><br/>\r\n");
      }else{
      $logs=file(_ROOT."/logs_old/$cid");
      ...
      $npg=$pg+9;
      printrus
("<a href=\"mpan1.php?$ses&amp;go=logs&amp;cid=$cid&amp;pg=$npg\">далее..</a>
<br/>
");
         }
      ...
      if ($pg>0){
         $npg = max(0,$pg-9);
         printrus
("<a href=\"mpan1.php?$ses&amp;go=logs&amp;cid=$cid&amp;pg=$npg\">назад..</a>
<br/>
");
         }
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=logs&amp;cid=$cid\" method=\"post\">
...
if (mysql_num_rows($r)==0 && !isset($_REQUEST[id]) && !isset($cid)){
   ...
   if (!file_exists(_ROOT."/logs_old/sg$cid")){
      printrus ("<b>!</b>По этой стране нет логов сжиганий<b>!</b><br/>\r\n");
      }else{
      $logs=file(_ROOT."/logs_old/sg$cid");
      for ($i=$pg;$i<count($logs)&&$i<$pg+10;$i++){
          printrus($logs[$i]."<br/>");
          }
      if ($i<count($logs)){
      $npg=$pg+9;
      printrus
("<a href=\"mpan1.php?$ses&amp;go=logsjech&amp;cid=$cid&amp;pg=$npg\">далее..</a>
<br/>
");
         }
      if ($pg>0){
         $npg = max(0,$pg-9);
         printrus
("<a href=\"mpan1.php?$ses&amp;go=logsjech&amp;cid=$cid&amp;pg=$npg\">назад..</a><br/>
");
         }
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=logsjech&amp;cid=$cid\" method=\"post\">
<input type=\"submit\" value=\"Перейти\"/>\n");
printrus (" к <input name=\"pg\" maxlength=\"4\" format=\"*N\" value=\"$pg\" title=\"Page\"/></form> записи (из ".count($logs).")<br/>");
unset($logs);
      }
...
if (mysql_num_rows($r)==0){
   ...
   //Сдесь пишем систему сжиганий!
    ...
    printrus ("<form name=\"\" action=\"mpan1.php?do&amp;$ses&amp;go=sjech&amp;cid=$cid\" method=\"post\">
...
if (mysql_num_rows($r)==0){
   ...
   //Сдесь пишем систему рисования!
    ...
    printrus ("<form name=\"\" action=\"mpan1.php?do&amp;$ses&amp;go=narisovat&amp;cid=$cid\" method=\"post\">
<input name=\"cnt\" maxlength=\"50\" title=\"Text\" value=\"\"/>
    <br/>\n");
...
");
    ...
    $error=(1==2)?'У государства <u>'.$e['countryName'].'</u> нет столько '.$l.'!<br />':'';
    $error=($cnt<1)?'Нельзя нарисовать мньше 1 '.$l.'!<br />':$error;
    $error=($why=='')?'Вы не написали причину для рисования '.$l.'!<br />':$error;
    if($error!=''){
     printrus("$error");
     }else{
    printrus("
...
if (mysql_num_rows($r)==0 && !isset($_REQUEST[id]) && !isset($cid)){
   ...
   if (!file_exists(_ROOT."/logs_old/cit$cid")){
      printrus ("<b>!</b>По этой стране нет логов цитадели<b>!</b><br/>\r\n");
      }else{
      $logs=file(_ROOT."/logs_old/cit$cid");
      for ($i=$pg;$i<count($logs)&&$i<$pg+10;$i++){
          printrus($logs[$i]."<br/>");
          }
      if ($i<count($logs)){
      $npg=$pg+9;
      printrus
("<a href=\"mpan1.php?$ses&amp;go=logscit&amp;cid=$cid&amp;pg=$npg\">далее..</a>
<br/>
");
         }
      if ($pg>0){
         $npg = max(0,$pg-9);
         printrus
("<a href=\"mpan1.php?$ses&amp;go=logscit&amp;cid=$cid&amp;pg=$npg\">назад..</a><br/>
");
         }
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=logscit&amp;cid=$cid\" method=\"post\">
<input type=\"submit\" value=\"Перейти\"/>\n");
printrus (" к <input name=\"pg\" maxlength=\"4\" format=\"*N\" value=\"$pg\" title=\"Page\"/></form> записи (из ".count($logs).")<br/>");
unset($logs);
      }
...
if (mysql_num_rows($r)==0 && !isset($_REQUEST[id]) && !isset($cid)){
   ...
   if (!file_exists(_ROOT."/logs_old/works$cid")){
      printrus ("<b>!</b>По этой стране нет логов работ<b>!</b><br/>\r\n");
      }else{
      $logs=file(_ROOT."/logs_old/works$cid");
      for ($i=$pg;$i<count($logs)&&$i<$pg+10;$i++){
          printrus($logs[$i]."<br/>");
          }
      if ($i<count($logs)){
      $npg=$pg+9;
      printrus
("<a href=\"mpan1.php?$ses&amp;go=logsworks&amp;cid=$cid&amp;pg=$npg\">далее..</a><br/>
");
         }
      if ($pg>0){
         $npg = max(0,$pg-9);
         printrus
("<a href=\"mpan1.php?$ses&amp;go=logsworks&amp;cid=$cid&amp;pg=$npg\">назад..</a><br/>
");
         }
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=logsworks&amp;cid=$cid\" method=\"post\">
<input type=\"submit\" value=\"Перейти\"/>\n");
printrus (" к <input name=\"pg\" maxlength=\"4\" format=\"*N\" value=\"$pg\" title=\"Page\"/></form> записи (из ".count($logs).")<br/>");
unset($logs);
      }
...
if (mysql_num_rows($r)==0 && !isset($_REQUEST[id]) && !isset($cid)){
   ...
   if (!file_exists(_ROOT."/logs_old/mes$cid")){
      printrus ("<b>!</b>По этой стране нет логов общения<b>!</b><br/>\r\n");
      }else{
      $logs=file(_ROOT."/logs_old/mes$cid");
      for ($i=$pg;$i<count($logs)&&$i<$pg+10;$i++){
          printrus($logs[$i]."<br/>");
          }
      if ($i<count($logs)){
      $npg=$pg+9;
      printrus
("<a href=\"mpan1.php?$ses&amp;go=logsmes&amp;cid=$cid&amp;pg=$npg\">далее..</a><br/>
");
         }
      if ($pg>0){
         $npg = max(0,$pg-9);
         printrus
("<a href=\"mpan1.php?$ses&amp;go=logsmes&amp;cid=$cid&amp;pg=$npg\">назад..</a><br/>
");
         }
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=logsmes&amp;cid=$cid\" method=\"post\">
<input type=\"submit\" value=\"Перейти\"/>\n");
printrus (" к <input name=\"pg\" maxlength=\"4\" format=\"*N\" value=\"$pg\" title=\"Page\"/></form> записи (из ".count($logs).")<br/>");
unset($logs);
      }
...
if (mysql_num_rows($r)==0 && !isset($_REQUEST[id]) && !isset($cid)){
   ...
   if (!file_exists(_ROOT."/logs_old/zah$cid")){
      printrus ("<b>!</b>По этой стране нет логов захватов<b>!</b><br/>\r\n");
      }else{
      $logs=file(_ROOT."/logs_old/zah$cid");
      for ($i=$pg;$i<count($logs)&&$i<$pg+10;$i++){
          printrus($logs[$i]."<br/>");
          }
      if ($i<count($logs)){
      $npg=$pg+9;
      printrus
("<a href=\"mpan1.php?$ses&amp;go=logszah&amp;cid=$cid&amp;pg=$npg\">далее..</a><br/>
");
         }
      if ($pg>0){
         $npg = max(0,$pg-9);
         printrus
("<a href=\"mpan1.php?$ses&amp;go=logszah&amp;cid=$cid&amp;pg=$npg\">назад..</a><br/>
");
         }
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=logszah&amp;cid=$cid\" method=\"post\">
<input type=\"submit\" value=\"Перейти\"/>\n");
printrus (" к <input name=\"pg\" maxlength=\"4\" format=\"*N\" value=\"$pg\" title=\"Page\"/></form> записи (из ".count($logs).")<br/>");
unset($logs);
      }
...
if (mysql_num_rows($r)==0 && !isset($_REQUEST[id]) && !isset($cid)){
   ...
   if (!file_exists(_ROOT."/logs_old/war$cid")){
      printrus ("<b>!</b>По этой стране нет логов войн<b>!</b><br/>\r\n");
      }else{
      $logs=file(_ROOT."/logs_old/war$cid");
      for ($i=$pg;$i<count($logs)&&$i<$pg+10;$i++){
          printrus($logs[$i]."<br/>");
          }
      if ($i<count($logs)){
      $npg=$pg+9;
      printrus
("<a href=\"mpan1.php?$ses&amp;go=logswars&amp;cid=$cid&amp;pg=$npg\">далее..</a><br/>
");
         }
      if ($pg>0){
         $npg = max(0,$pg-9);
         printrus
("<a href=\"mpan1.php?$ses&amp;go=logswars&amp;cid=$cid&amp;pg=$npg\">назад..</a><br/>
");
         }
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=logswars&amp;cid=$cid\" method=\"post\">
<input type=\"submit\" value=\"Перейти\"/>\n");
printrus (" к <input name=\"pg\" maxlength=\"4\" format=\"*N\" value=\"$pg\" title=\"Page\"/></form> записи (из ".count($logs).")<br/>");
unset($logs);
      }
...
if (mysql_num_rows($r)==0 && !isset($_REQUEST[id]) && !isset($cid)){
   ...
   if (!file_exists(_ROOT."/logs_old/sos$cid")){
      ...
      $logs=file(_ROOT."/logs_old/sos$cid");
      for ($i=$pg;$i<count($logs)&&$i<$pg+10;$i++){
          printrus($logs[$i]."<br/>");
          }
      if ($i<count($logs)){
      $npg=$pg+9;
      printrus
("<a href=\"mpan1.php?$ses&amp;go=logssos&amp;cid=$cid&amp;pg=$npg\">далее..</a><br/>
");
         }
      if ($pg>0){
         $npg = max(0,$pg-9);
         printrus
("<a href=\"mpan1.php?$ses&amp;go=logssos&amp;cid=$cid&amp;pg=$npg\">назад..</a><br/>
");
         }
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=logssos&amp;cid=$cid\" method=\"post\">
<input type=\"submit\" value=\"Перейти\"/>\n");
printrus (" к <input name=\"pg\" maxlength=\"4\" format=\"*N\" value=\"$pg\" title=\"Page\"/></form> записи (из ".count($logs).")<br/>");
unset($logs);
      }
...
if (mysql_num_rows($r)==0 && !isset($_REQUEST[id]) && !isset($cid)){
   ...
   if (!file_exists(_ROOT."/logs_old/magaz$cid")){
      ...
      $npg=$pg+9;
      printrus
("<a href=\"mpan1.php?$ses&amp;go=logsmag&amp;cid=$cid&amp;pg=$npg\">далее..</a><br/>
");
         }
      if ($pg>0){
         $npg = max(0,$pg-9);
         printrus
("<a href=\"mpan1.php?$ses&amp;go=logsmag&amp;cid=$cid&amp;pg=$npg\">назад..</a><br/>
");
         }
printrus ("<form name=\"\" action=\"mpan1.php?$ses&amp;go=logsmag&amp;cid=$cid\" method=\"post\">
<input type=\"submit\" value=\"Перейти\"/>\n");
printrus (" к <input name=\"pg\" maxlength=\"4\" format=\"*N\" value=\"$pg\" title=\"Page\"/></form> записи (из ".count($logs).")<br/>");;
unset($logs);
      }
...
");
printrus ("<br/><a href=\"mpan1.php?$ses\">ок</a><br/>\n");
}else if ($go=='help'){
...
printrus ("<a href=\"mpan1.php?$ses\">ок</a><br/>\n");
}else if ($go=='rename'){
if ($t1=='1') $name=translit($name);
$name = iconv('utf-8','cp1251',$name);
$r = mysql_query("SELECT * FROM `countries` WHERE countryName = '$name' LIMIT 1");
