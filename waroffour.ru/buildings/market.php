...
");
  ...
  printrus
("<a href=\"market.php?$ses&amp;m=space\">Территория</a>
[$space]
<br/>
");
  $iron=$b['iron'];
  ...
  $oil=$b['oil'];
  printrus
("<a href=\"market.php?$ses&amp;m=market&amp;n=iron\">Железо</a>
[$iron]
<br/>
");
  printrus
("<a href=\"market.php?$ses&amp;m=market&amp;n=arbor\">Древесина</a>
[$arbor]
<br/>
");
  printrus
("<a href=\"market.php?$ses&amp;m=market&amp;n=grain\">Зерно</a>
[$grain]
<br/>
");
  printrus
("<a href=\"market.php?$ses&amp;m=market&amp;n=stone\">Камень</a>
[$stone]
<br/>
");
  printrus
("<a href=\"market.php?$ses&amp;m=market&amp;n=oil\">Нефть</a>
[$oil]
<br/>
");
  if($hits<100){
   printrus
("<a href=\"market.php?$ses&amp;m=repaire\">Починить</a>
(".mkWarning($hits)."%)
<br/>
");
  }
...
//Рынок:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 ...
 $key=_PREFIKS.':market'.$countryID;
   ...
   if($num>0){
    ...
    <form name=\"\" action=\"market.php?$ses&amp;n=$n&amp;m=takeoffpart\" method=\"post\">
...
");
   printrus
("<a href=\"market.php?$ses&amp;m=add&amp;n=$n\">Еще на продажу</a>
<br/>
");
    printrus
("<a href=\"market.php?$ses&amp;m=takeoff&amp;n=$n\">Снять с продажи</a>
<br/>
");
    printrus
("<a href=\"market.php?$ses&amp;m=chprice&amp;n=$n\">Изменить цену</a>
<br/>
");
   }else{
    printrus
("<a href=\"market.php?$ses&amp;m=sell&amp;n=$n\">Продать...</a>
<br/>
");
   }
...
$result=MYSQL_QUERY($query);
$num=mysql_num_rows($result);*/
printrus("<i>Мин. цены на ".get_res_name_vin($n).":</i> <b>".$l['cnt']."</b> <i>ед.</i><br />
<i>Мировая цена </i> <b>".$l['price']."</b> <i>денег.</i><br />
<a href=\"market.php?$ses&amp;m=buy&amp;n=$n&amp;micro\">Купить</a><br />");

//$b=market(1);
printrus("<i>Общий рынок ".get_res_name_rod($n).":</i> <b>".$a['cnt']."</b> <i>ед.</i><br />
<i>Мировая цена </i> <b>".($a['price'])."</b> <i>денег.</i><br />
<a href=\"market.php?$ses&amp;m=buy&amp;n=$n\">Купить</a><br />");
...
printrus
("<a href=\"market.php?$ses&amp;m=buy&amp;n=$n&amp;seller=$sellerID\">Купить</a>
<br/>
");
   }
}
...
$npg = $pg+9;
printrus
("<a href=\"market.php?$ses&amp;m=market&amp;n=$n&amp;seller=$sellerID&amp;pg=$npg\">далее...</a>
<br/>
");
}
...
$npg = max(0,$pg-9);
printrus
("<a href=\"market.php?$ses&amp;m=market&amp;n=$n&amp;seller=$sellerID&amp;pg=$npg\">назад...</a>
<br/>
");
} */
break;
...
//Продажа:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 ...
 if ($attCount>0){$SELL = FALSE;}else{$SELL = TRUE;}
...
if (($SELL == FALSE and $att_us['race']!=2) or ($SELL == FALSE and $att_us['race']==2 and $def_num>0)){
printrus("Вы не можете ничего продавать, пока вражеские войска стоят на Вашей территории!<br/>\n");
printrus
("<a href=\"market.php?$ses&amp;m=market&amp;n=$n\">Ok</a>
<br/>
");
printrus
("
...
");
    ...
    printrus ("<form name=\"\" action=\"market.php?$ses&amp;m=sell&amp;n=$n\" method=\"post\">
<input format='*N' name='count' /><br/>\r\n");
...
");
    ...
    printrus
("<a href=\"market.php?$ses&amp;m=sell&amp;n=$n&amp;count=".($b["$n"])."&amp;price=$price\">Продать все</a>
<br/>
");
   }elseif($n=='grain'&&($b["$n"]-$count<10000)){
   printrus ("В запасах должно оставаться минимум <b>10000</b> зерна!<br/>\r\n");
   printrus ("<form name=\"\" action=\"market.php?$ses&amp;m=sell&amp;n=$n&amp;price=$price\" method=\"post\">
<input format='*N' name='count' /><br/>\r\n");
    printrus
...
if (($SELL == FALSE and $att_us['race']!=2) or ($SELL == FALSE and $att_us['race']==2 and $def_num>0)){
    ...
    printrus
("<a href=\"market.php?$ses&amp;m=market\">Ok</a>
<br/>
");
die("");
}
...
printrus ("Рынок ".get_res_name_rod($n).":<br/>\r\n");
   ...
   if($num<=0){
    ...
    printrus ("<form name=\"\" action=\"market.php?$ses&amp;m=add&amp;n=$n\" method=\"post\">
<input format='*N' name='count' /><br/>\r\n");
    printrus
("<input type=\"submit\" value=\"Продать\"/>
</form>
...
");
    ...
    printrus ("У вас только <b>".$b["$n"]."</b> ".get_res_name_rod($n)."!<br/>\r\n");
    printrus
("<a href=\"market.php?$ses&amp;m=add&amp;n=$n&amp;count=".($b["$n"])."\">Продать все</a>
<br/>
");
...
printrus ("Рынок ".get_res_name_rod($n).":<br/>\r\n");
   ...
   if($num<=0){
    ...
    printrus ("<form name=\"\" action=\"market.php?$ses&amp;m=chprice&amp;n=$n\" method=\"post\">
<input name='price' /><br/>\r\n");
    printrus
...
//Убираем с продажи:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 ...
 printrus ("Рынок ".get_res_name_rod($n).":<br/>\r\n");
   ...
   if($num<=0){
    ...
    printrus
("<a href=\"market.php?$ses&amp;m=takeoff&amp;n=$n&amp;sure=sure\">Да</a>
<br/>
");
    printrus
("<a href=\"market.php?$ses&amp;m=market&amp;n=$n\">Отмена</a>
<br/>
");
   }else{
    $cnt = $a['count'];
 ...
 case('buy'):
  ...
  printrus ("Рынок ".get_res_name_rod($n).":<br/>\r\n");
   ...
   if(empty($count) || $count<=0){
    ...
    printrus ("<form name=\"\" action=\"market.php?$ses&amp;m=buy&amp;n=$n&amp;seller=$sellerID$url\" method=\"post\">
<input format='*N' name='count' /><br/>\r\n");
    printrus
...
");
    ...
    printrus
("<a href=\"market.php?$ses&amp;m=buy&amp;n=$n&amp;seller=$sellerID&amp;count=".$cnt."$url\">Купить все</a>
<br/>
");
...
");
   ...
   printrus ("У вас не хватает места на складе! (влезет только ".$frpl." ".get_res_name_rod($n).")<br/>\r\n");
    $vl = $frpl;
    printrus
("<a href=\"market.php?$ses&amp;m=buy&amp;n=$n&amp;seller=$sellerID&amp;count=".$vl."$url\">Купить сколько влезет</a>
<br/>
");
...
//Изменение территории::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 case('space'):
  ...
  if(empty($n)){
   printrus ("Вы хотите\r\n");
   printrus
("<a href=\"market.php?$ses&amp;m=space&amp;n=plus\">увеличить</a>
");
   printrus ("или\r\n");
   printrus
("<a href=\"market.php?$ses&amp;m=space&amp;n=minus\">уменьшить</a>
");
   printrus ("территорию рынка?<br/>\r\n");
   printrus
("
<a href='market.php?$ses'>Отмена</a>
<br/>
");
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
");
   ...
   printrus
("<a href=\"market.php?$ses&amp;m=space&amp;n=plus&amp;spaceto=$space_free\">Использовать всю землю</a>
<br/>
");
   printrus
("
...
//уменьшаем территорию^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   ...
   printrus ("<form name=\"\" action=\"market.php?$ses&amp;m=space&amp;n=minus\" method=\"post\">
<input format='*N' name='spaceto' /><br/>");
   printrus
("<input type=\"submit\" value=\"Ok\"/>
</form>
...
");
   ...
   printrus
("<a href=\"market.php?$ses&amp;m=space&amp;n=minus&amp;spaceto=".(round($place_free/100)-1)."\">Уменьшить</a>
<br/>
");
   printrus
("<a href=\"market.php?$ses&amp;m=space&amp;n=minus\">Отмена</a>
<br/>
");
  }elseif($n=="minus"){
   //устанавливаем изменившиеся значения ресурсов:
