...
if($_POST['LMI_PREREQUEST']==1) {
  ...
  if(trim($_POST['LMI_PAYEE_PURSE'])!="B254965832143") {
...
$partner = $a['partner']; //от партнера
 ...
 if(trim($_POST['LMI_PAYEE_PURSE'])=="B254965832143" && $res[1]=="274") //1
                {$sum=$sum+1;}
 if(trim($_POST['LMI_PAYEE_PURSE'])=="B254965832143" && $res[1]=="1370") //5
                {$sum=$sum+6;}
  if(trim($_POST['LMI_PAYEE_PURSE'])=="B254965832143" && $res[1]=="6850") //25
                {$sum=$sum+28;}
  if(trim($_POST['LMI_PAYEE_PURSE'])=="B254965832143" && $res[1]=="27400") //100
                {$sum=$sum+115;}
  if(trim($_POST['LMI_PAYEE_PURSE'])=="B254965832143" && $res[1]=="137000") //500
                {$sum=$sum+650;}
