...
/////////////////
                    ...
                    if ($sphone == "6915") //150
                    {
                        $smsResponse = "Счет пользователя пополнен на 54 золотых. imperia.mobi";
                    }
                    if ($sphone == "7914") //180
                    {
                    ...
                    if ($sphone == "7915") //420
                    {
                        $smsResponse = "Счет пользователя пополнен на 66 золотых. imperia.mobi";
                    }
                    if ($sphone == "7916") //690
                    {
                        $smsResponse = "Счет пользователя пополнен на 164 золотых. imperia.mobi";
                    }
            }
		}else{
		echo 'Error!';
