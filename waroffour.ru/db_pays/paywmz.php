...
if($_POST['LMI_PREREQUEST']==1) {
  ...
  if(trim($_POST['LMI_PAYEE_PURSE'])!="Z237855762866") {
...
$partner = $a['partner']; //от партнера
 ...
 if(trim($_POST['LMI_PAYEE_PURSE'])=="Z237855762866" && $res[1]=="0.03") //1
                {$sum=$sum+1;}
 if(trim($_POST['LMI_PAYEE_PURSE'])=="Z237855762866" && $res[1]=="0.15") //5
                {$sum=$sum+6;}
  if(trim($_POST['LMI_PAYEE_PURSE'])=="Z237855762866" && $res[1]=="0.75") //25
                {$sum=$sum+28;}
  if(trim($_POST['LMI_PAYEE_PURSE'])=="Z237855762866" && $res[1]=="3") //100
                {$sum=$sum+115;}
  if(trim($_POST['LMI_PAYEE_PURSE'])=="Z237855762866" && $res[1]=="15") //500
                {$sum=$sum+650;}
