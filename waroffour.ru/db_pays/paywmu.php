...
if($_POST['LMI_PREREQUEST']==1) {
  ...
  if(trim($_POST['LMI_PAYEE_PURSE'])!="U103003280857") {
...
$partner = $a['partner']; //от партнера
 ...
 if(trim($_POST['LMI_PAYEE_PURSE'])=="U103003280857" && $res[1]=="0.25") //1
                {$sum=$sum+1;}
 if(trim($_POST['LMI_PAYEE_PURSE'])=="U103003280857" && $res[1]=="1.25") //5
                {$sum=$sum+6;}
  if(trim($_POST['LMI_PAYEE_PURSE'])=="U103003280857" && $res[1]=="6.25") //25
                {$sum=$sum+28;}
  if(trim($_POST['LMI_PAYEE_PURSE'])=="U103003280857" && $res[1]=="25") //100
                {$sum=$sum+115;}
  if(trim($_POST['LMI_PAYEE_PURSE'])=="U103003280857" && $res[1]=="125") //500
                {$sum=$sum+650;}
