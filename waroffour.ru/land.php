...
//Рисуем всякие цыферки-ссылочки разные*****************************************
 ...
 $land=countAllLand($b['countryID']);
 printrus ("(<b>$land</b>)<br/>\r\n");
 $freeland=countFreeLand($b['countryID']);
 printrus ("Свободно: <b>$freeland</b><br/>\r\n");
 $forest=$b['forest'];
 $mountains=$b['mountains'];
 printrus ("Леса: <b>$forest</b><br/>\r\n");
 printrus ("Горы: <b>$mountains</b><br/>\r\n");
