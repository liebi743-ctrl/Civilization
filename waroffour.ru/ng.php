 ...
 */
  ...
  */
  ...
  if ($nz=isNewBuildings($countryID,'dungeon') and ($nz['un_3']+259200) > time()){$messages.="Артефакт мешочек с деньгами принес +<b>10000</b> денег,<br />"; $money_plus+=10000;}
  ...
  $all_farm=$vs_cow*8000+$vs_mutton*1000+$vs_goat*3000+$vs_pig*6000;
  }
...
$query = "SELECT (land+mountains+forest) as fland,countryName FROM `countries` WHERE ip!='' and ip!='sysreg' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' order by (land+mountains+forest) desc LIMIT 10";
$r = mysql_query($query);
...
10*weapon_speed_8) as koef,countryName FROM `countries` WHERE ip!='' and ip!='sysreg' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' order by koef desc LIMIT 10";
$r = mysql_query($query);
...
$query = "SELECT expiriense,countryName FROM `general`,`countries` WHERE ip!='sysreg' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' and general.countryID = countries.countryID and countries.ip!='' order by expiriense desc LIMIT 10";
$r = mysql_query($query);
...
$query = "SELECT (study+moral) as koef,countryName FROM `general`,`countries` WHERE ip!='sysreg' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' and general.countryID = countries.countryID and countries.ip!='' order by (study+moral) desc LIMIT 10";
$r = mysql_query($query);
...
$query = "SELECT (0.2*grain+arbor+4*stone+12*iron+20*oil) as koef,countryName FROM `countries` WHERE ip!='' and ip!='sysreg' and ip!='botsysreg1' and ip!='botsysreg2' and ip!='botsysreg3' and ip!='botsysreg4' and ip!='botsysreg5' and ip!='botsysreg6' and ip!='botsysreg7' and ip!='botsysreg8' and ip!='botsysreg9' and ip!='botsysreg10' and ip!='botsysreg11' and ip!='botsysreg12' and ip!='botsysreg13' and ip!='botsysreg14' and ip!='botsysreg15' and ip!='botsysreg16' and ip!='botsysreg17' and ip!='botsysreg18' and ip!='botsysreg19' and ip!='botsysreg20' order by koef desc LIMIT 10";
$r = mysql_query($query);
