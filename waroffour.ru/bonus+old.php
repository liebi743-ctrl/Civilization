...
if( !isset($_SESSION['auth']) && !isset($_SESSION['auth2'])){
	...
	if ( (     in_array($_GET[m], $forbidden)    )   AND   (    !isset($_SESSION['auth'])   OR     isset($_SESSION['dies'])  )  ){
	//include_once("other_inc/footer.php");
	//die();
	$_REQUEST[m]='';
	$_GET[m] = '';
	$m='';
	printrus("Внимание! Некоторые услуги могут быть недоступны, так как у вас нет страны либо она мертва.<br/>");
	}
...
{}else{
if(isset($_SESSION['o_uid']) || isset($_SESSION['mr_uid']) || ($_SERVER[HTTP_HOST] == 'imperia.mgates.ru' AND $_GET['sid'] == '')){}else{
printrus('<img src="/img/ico/cr3.png" alt="" /><span style="color:#6FCD72"><b>Акция!!</b></span> <span style="color:#6FCD72">Пополни счет любым платежом, на любую сумму и получи + 100% Золота. Например, при пополнении на <img src="/img/ico/cr3.png" alt="" />100 + <img src="/img/ico/cr3.png" alt="" />100 в подарок</span><br/>');
$date = strtotime("03 January 2013");  
   
 $sec=$date - time(); 
 $days2=floor(($date - time()) /86400);  
 $h1=floor(($date - time()) /3600);  
 $m1=floor(($date - time()) /60);  
 $hour=floor($sec/60/60 - $days2*24);  
 $hours=floor($sec/60/60);  
 $min=floor($sec/60 - $hours*60);  
   
 switch(substr($days2, -1)){  
 case 1: $o='остался';  
 break;  
 case 2: case 3: case 4: case 5: case 6: case 7: case 8: case 9: case 0: $o='осталось';  
 break;}  
   
 switch(substr($days2, -2)){  
 case 1: $d='день';  
 break;  
...
//if ($sec>0) printrus( '<span style="color:#FF8040">До конца акции '.$o.' '); if ($days2>0) printrus( '<b>'.$days2.'</b> '.$d.' '); if ($h1>0) printrus( '<b>'.$hour.'</b> '.$h.''); if ($m1>0) printrus( ' и <b>'.$min.'</b> '.$mm.'</span>'); if ($sec<0) printrus( "Акция закончилась!");
printrus( '<br/>');
}
...
<input type="submit" value=" купить "/> 1 Золото! <span class="green">(+ <img src="/img/ico/cr3.png" alt="" />1 в подарок)</span>
</form><br/>
...
<input type="hidden" name="name" value="'.$userID.'"/>
<input type="submit" value=" купить "/> 5 Золото! <span class="green">(+ <img src="/img/ico/cr3.png" alt="" />5 в подарок)</span>
</form><br/>
...
<input type="hidden" name="name" value="'.$userID.'"/>
<input type="submit" value=" купить "/> 25 Золото! <span class="green">(+ <img src="/img/ico/cr3.png" alt="" />25 в подарок)</span>
</form><br/>
...
<input type="hidden" name="name" value="'.$userID.'"/>
<input type="submit" value=" купить "/> 100 Золото! <span class="green">(+ <img src="/img/ico/cr3.png" alt="" />100 в подарок)</span>
</form><br/>
...
<input type="hidden" name="name" value="'.$userID.'"/>
<input type="submit" value=" купить "/> 500 Золото! <span class="green">(+ <img src="/img/ico/cr3.png" alt="" />500 в подарок)</span>
</form><br/>
');
printrus('<br/><a href="bonus.php?m=owm">Порядок оплаты</a>
');
...
<a href="sms:4445?body=imp+'.$userID.'">4445</a> - <img src="/img/ico/cr3.png" alt="" />6<span class="green">+6</span> золота <span class="green">в подарок</span> <span class="low">(~16.3 руб.*)</span><br/>
<a href="sms:4446?body=imp+'.$userID.'">4446</a> - <img src="/img/ico/cr3.png" alt="" />12<span class="green">+12</span> золота <span class="green">в подарок</span> <span class="low">(~26.8 руб.*)</span><br/><br/>');

// Узбекистан
printrus('<b>Для Узбекистана:</b><br/>
<a href="sms:4446?body=imp+'.$userID.'">4446</a> - <img src="/img/ico/cr3.png" alt="" />12<span class="green">+12</span> золота <span class="green">в подарок</span> <span class="low">(~26.8 руб.*)</span><br/>
<a href="sms:4449?body=imp+'.$userID.'">4449</a> - <img src="/img/ico/cr3.png" alt="" />36<span class="green">+36</span> золота <span class="green">в подарок</span> <span class="low">(~81.4 руб.*)</span><br/><br/>
');

// Армения
printrus('<b>Для Армении:</b><br/>
<a href="sms:4446?body=imp+'.$userID.'">4446</a> - <img src="/img/ico/cr3.png" alt="" />12<span class="green">+12</span> золота <span class="green">в подарок</span> <span class="low">(~26.8 руб.*)</span><br/>
<a href="sms:4448?body=imp+'.$userID.'">4448</a> - <img src="/img/ico/cr3.png" alt="" />24<span class="green">+24</span> золота <span class="green">в подарок</span> <span class="low">(~54.2 руб.*)</span><br/>
<a href="sms:4449?body=imp+'.$userID.'">4449</a> - <img src="/img/ico/cr3.png" alt="" />36<span class="green">+36</span> золота <span class="green">в подарок</span> <span class="low">(~81.4 руб.*)</span><br/><br/>
');
...
<a href="sms:4446?body=imp+'.$userID.'">4446</a> - <img src="/img/ico/cr3.png" alt="" />12<span class="green">+12</span> золота <span class="green">в подарок</span> <span class="low">(~26.8 руб.*)</span><br/>
<a href="sms:4449?body=imp+'.$userID.'">4449</a> - <img src="/img/ico/cr3.png" alt="" />36<span class="green">+36</span> золота <span class="green">в подарок</span> <span class="low">(~81.4 руб.*)</span><br/>
<a href="sms:4161?body=imp+'.$userID.'">4161</a> - <img src="/img/ico/cr3.png" alt="" />57<span class="green">+57</span> золота <span class="green">в подарок</span> <span class="low">(~128.8 руб.*)</span><br/><br/>
<span class="low">
Поддержка по вопросам платежей<br/>
...
printrus("<a href=\"http://m.xsolla.com/index.php?action=form&amp;id_project=5490&amp;id_rubric=7&amp;pid=26&amp;local=ru&amp;v1=".$userID."&amp;email=".$e_mail."\"><b>Купить Золото</b></a>");
...
printrus('<img src="/img/ico/cr3.png" alt="." />1 золото = 1 рубль<br/><br/>');
printrus("<a href=\"http://m.xsolla.com/index.php?id_project=5490&amp;local=ru&amp;v1=".$userID."&amp;email=".$e_mail."\"><b>Купить Золото</b></a>");
...
printrus('<img src="/img/ico/cr3.png" alt="." />1 золото = 1 рубль<br/><br/>');
printrus("<a href=\"http://m.xsolla.com/index.php?action=form&amp;id_project=5490&amp;id_rubric=2&amp;pid=27&amp;local=ru&amp;v1=".$userID."&amp;email=".$e_mail."\"><b>Купить Золото</b></a>");
