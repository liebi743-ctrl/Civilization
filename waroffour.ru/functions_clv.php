...
define("_ROOT","/www/imp.d/waroffour/data/www/waroffour.ru");
define("_CONFIG","/www/imp.d/waroffour/data/www");
#define("_ROOT","/www/imp.d/imp_test/data/www/local.site");
//==============================================================================
//Константы
//
...
global $mgates_data, $mgates_info;
	...
	*/
	...
	include_once '/www/imp.d/waroffour/data/www/waroffour.ru/api/mgates-class.php';
	global $mgates;
...
function takecountry($countryID,$targetID,$att_wariors){
 ...
 if(($def_wariors[0]+$def_wariors[1]+$def_wariors[2]+$def_wariors[3]+$def_wariors[4]+$def_wariors[5]+$def_wariors[6]+$def_wariors[7])<=0){
  ...
  $log = "Вы не потеряв ни одного воина с захватили незащищенное гос-во <u>$target</u>! $str.<br/>\r\n";
