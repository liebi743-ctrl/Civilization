...
printrus("Полнометражный фильм Дети 90-х(8-серий).(г.Чита)<br/>");

echo '<iframe width="180" height="120" src="https://www.youtube.com/embed/G_28AqeneBY?list=PL1SxkCC1lVeBM6NIMI2hu3KmaF7l_Kt8E" frameborder="0" allowfullscreen></iframe><br /><br />';


printrus ("<a href='chat_3.php?$ses'>Медеа чат</a><br/><br />");
