...
//Мараторий ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 ...
 if ($nightmar==TRUE){
  ...
  printrus ("<u>Ночной мораторий</u><br/>\r\n");
  printrus ("Осталось ".mkTimeStr($tleft)."<br/>\r\n");
  print "-----<br/>\r\n";
    }
}else{
printrus("<u>Купленный мораторий:</u><br/>\r\n");
...
//Строящиеся здания:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 ...
 if($buildings>0){
  ...
  for ($i=0;$i<count($result);$i++){
   ...
   printrus
("<b></b><ul class=\"navs\"><li><a href=\"works.php?kind=building&amp;what=$building&amp;$ses\"><img src=\"/img/ico/build.png\" class=\"menu\" alt=\"\" />".printBuilding($building)." <span class=\"white\">(<b>$percent</b>%)</span></a>
<b></b>
</li></ul>
");
  }
...
<img src=\"/img/ico/build.png\" class=\"menu\" alt=\"\" />".printBuilding($building)." <span class=\"white\">[$guard]</span></a>
</li></ul>
");
   }else{
    //$started=@mysql_result($result_,0,"started");
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//деньги::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
if(isset($_SESSION['mr_uid']) || $_SERVER[HTTP_HOST] == 'imperia.mgates.ru')
{
if (_SHOP=="on")printrus ("<ul class=\"navs\"><li><a href='bonus.php?$ses'><img src=\"/img/ico/cr3.png\" class=\"menu\" alt=\"\" />Купить золото</a></li></ul>");
}else{
if (_SHOP=="on")printrus ("<ul class=\"navs\"><li><a href='bonus.php?$ses'><img src=\"/img/ico/cr3.png\" class=\"menu\" alt=\"\" />Купить золото <span class=\"color:#6FCD72\">(Акция)</span></a></li></ul>");
}
...
//if (_SHOP=="oof")printrus ("<a href='bonus.php?$ses'>Купить золота</a>");
