...
if($fa['class'] == 1){$class='Воин';}
elseif($fa['class'] == 2){$class='Торговец';}
elseif($fa['class'] == 3){$class='Странник';}
elseif($fa['class'] == 4){$class='Ремесленник';}
elseif($fa['class'] == 5){$class='Вор';}
elseif($fa['class'] == 6){$class='Дипломат';}
elseif($fa['class'] == 7){$class='Адмирал';}
elseif($fa['class'] == 8){$class='Разбойник';}
else{$class='Вася';}

if($fa['race'] == 1){$rassa="Демон"; $infor="<a href=\"http://".$_SERVER['SERVER_NAME']."/game.php?$ses\" class=\"r1\"><span>".$rassa." - ".$class."</span></a>";}
elseif($fa['race'] == 2){$rassa="Человек"; $infor="<a href=\"http://".$_SERVER['SERVER_NAME']."/game.php?$ses\" class=\"r2\"><span>".$rassa." - ".$class."</span></a>";}
elseif($fa['race'] == 3){$rassa="Нежить"; $infor="<a href=\"http://".$_SERVER['SERVER_NAME']."/game.php?$ses\" class=\"r3\"><span>".$rassa." - ".$class."</span></a>";}
elseif($fa['race'] == 4){$rassa="Гном"; $infor="<a href=\"http://".$_SERVER['SERVER_NAME']."/game.php?$ses\" class=\"r4\"><span>".$rassa." - ".$class."</span></a>";}
else{$rassa="Вася"; $infor="".$rassa." - ".$class."";}
